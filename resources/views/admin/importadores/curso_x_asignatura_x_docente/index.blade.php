...
<main id="main" class="main">
    @include('admin.importadores.curso_x_asignatura_x_docente.header',['title' => 'Importador de cursos-x-asign-x-docentes'])
      ...
      <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
        <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-md-12">
                  <h4>Importadores para cursos-x-asign-x-docentes</h4>
              </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12 col-xs-12">
                  ...
                  <span>La columna <strong>Curso_id</strong> es obligatoria y solo acepta números. Corresponde al ID del curso. El ID de cada curso se puede visualizar en la sección Cursos. </span>
                  <br>
            ...
            <div class="row">
              <form action="{{route('admin.importadores.upload_curso_x_asignatura_x_docente')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <br>
          ...
          <div class="card-footer">
            <div class="d-flex justify-content-start">
              <a name="" id="" class="btn btn-warning me-3 " href="{{route('admin.importadores.template_curso_x_asignatura_x_docente')}}" role="button">Descargar template</a>
