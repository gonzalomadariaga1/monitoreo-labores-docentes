...
<main id="main" class="main">
  @include('admin.curso_x_asignatura_x_docente.headersection',['title' => 'Lista de CxAxD'])
        ...
        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
          <div class="card">
            <div class="card-header">
              <div class="row">
                <div class="col-md-10">
                    <h4>Lista de CxAxD registrados en el sistema.</h4>
                </div>

                <div class="col-md-2">
                    <a href="{{route('admin.curso_x_asignatura_x_docente.create')}}" class="btn btn-primary-violet btn-sm float-md-end" 
                    role="button" aria-pressed="true"  style="margin-bottom: 5px;">Crear CxAxD</a>
                </div>
              </div>
            </div>
              ...
              <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 table-responsive">
                <table id="tabla_docentes" class="table table-striped table-bordered  table-hover" >
                    <thead style="background-color:#A27AD6">
                      ...
                      <th>Apellido materno docente</th>
                      <th>Acciones</th>                     
                    </thead>
                    <tbody>
                        {{-- @foreach ($rows as $row)
...
@section('code_js')
  <script>
      $('#deleteModal').on('show.bs.modal', function (event) {
        ...
        var url = '{{ route("admin.curso_x_asignatura_x_docente.destroy", ":id") }}';
...
<script>
  var table = $('#tabla_docentes').DataTable( {
    ...
    ajax:{
          url: '/curso_x_asignatura_x_docente/get_todo',
          type : "get",
          dataType : "json",						
          error: function(e){
