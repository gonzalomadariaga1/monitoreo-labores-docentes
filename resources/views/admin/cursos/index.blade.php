...
<main id="main" class="main">
  @include('admin.cursos.headersection',['title' => 'Lista de cursos'])
        ...
        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
          <div class="card">
            <div class="card-header">
              <div class="row">
                <div class="col-md-10">
                    <h4>Lista de cursos registrados en el sistema.</h4>
                </div>

                <div class="col-md-2">
                    <a href="{{route('admin.cursos.create')}}" class="btn btn-primary-violet btn-sm float-md-end" 
                    role="button" aria-pressed="true"  style="margin-bottom: 5px;">Crear curso</a>
                </div>
              </div>
            </div>
...
@section('code_js')
  <script>
      $('#deleteModal').on('show.bs.modal', function (event) {
        ...
        var url = '{{ route("admin.cursos.destroy", ":id") }}';
